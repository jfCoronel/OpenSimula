...
- **water_source** [_option_, default = "UNKNOWN", options = ["UNKNOWN","WATER_SYSTEM"]]: If the value is "UNKNOWN", the simulation will be carried out assuming that the coils are always fed at a fixed inlet water temperature and flow, given by "inlet_cooling_water_temp"/"inlet_heating_water_temp" and "cooling_water_flow"/"heating_water_flow". If the value is "WATER_SYSTEM" the coils are connected to the "HVAC_water_system" components referenced in "cooling_water_system"/"heating_water_system", which supply the inlet water temperature and add the coil load to the water loop.
- **cooling_water_system** [_component_, default = "not_defined", component type = HVAC_water_system]: Reference to the "HVAC_water_system" component that supplies the cooling coil when "water_source" is "WATER_SYSTEM".
- **heating_water_system** [_component_, default = "not_defined", component type = HVAC_water_system]: Reference to the "HVAC_water_system" component that supplies the heating coil when "water_source" is "WATER_SYSTEM".
- **cooling_water_flow** [_float_, unit = "dm³/s", default = 1, min = 0]: Cooling coil design water flow.
- **heating_water_flow** [_float_, unit = "dm³/s", default = 1, min = 0]: Heating coil design water flow.
- **inlet_cooling_water_temp** [_float_, unit = "°C", default = 7]: Inlet cooling water temperature used when "water_source" is "UNKNOWN".
- **inlet_heating_water_temp** [_float_, unit = "°C", default = 50]: Inlet heating water temperature used when "water_source" is "UNKNOWN".
...
- **water_source** [_option_, default = "UNKNOWN", options = ["UNKNOWN","WATER_SYSTEM"]]: If the value is "UNKNOWN", the simulation will be carried out assuming that the coils are always fed at a fixed inlet water temperature and flow, given by "inlet_cooling_water_temp"/"inlet_heating_water_temp" and "cooling_water_flow"/"heating_water_flow". If the value is "WATER_SYSTEM" the coils are connected to the "HVAC_water_system" components referenced in "cooling_water_system"/"heating_water_system", which supply the inlet water temperature and add the coil load to the water loop.
- **cooling_water_system** [_component_, default = "not_defined", component type = HVAC_water_system]: Reference to the "HVAC_water_system" component that supplies the cooling coil when "water_source" is "WATER_SYSTEM".
- **heating_water_system** [_component_, default = "not_defined", component type = HVAC_water_system]: Reference to the "HVAC_water_system" component that supplies the central heating coil when "water_source" is "WATER_SYSTEM".
- **cooling_water_flow** [_float_, unit = "dm³/s", default = 1, min = 0]: Cooling coil design water flow.
- **heating_water_flow** [_float_, unit = "dm³/s", default = 1, min = 0]: Central heating coil design water flow.
- **inlet_cooling_water_temp** [_float_, unit = "°C", default = 7]: Inlet cooling water temperature used when "water_source" is "UNKNOWN".
- **inlet_heating_water_temp** [_float_, unit = "°C", default = 50]: Inlet heating water temperature used when "water_source" is "UNKNOWN".
...
- **reheat_water_source** [_option_, default = "UNKNOWN", options = ["UNKNOWN","WATER_SYSTEM"]]: Same behaviour as "water_source" but applied to the reheat coils. If "WATER_SYSTEM" the reheat coils are connected to the "HVAC_water_system" referenced in "reheat_water_system".
- **reheat_water_system** [_component_, default = "not_defined", component type = HVAC_water_system]: Reference to the "HVAC_water_system" component that supplies the reheat coils when "reheat_water_source" is "WATER_SYSTEM".
