// `npm run build` (in this directory) bundles this file plus Ajv into
// static/editor.js, the single dependency-free module anywidget actually
// ships. It used to import Ajv straight from esm.sh, which works in
// JupyterLab but silently fails in VS Code: its notebook webview CSP blocks
// fetching third-party scripts, and modules loaded by anywidget from a blob
// URL can't resolve relative/bare imports either, so bundling is required.
