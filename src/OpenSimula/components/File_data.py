...
class File_data(Component):
    def __init__(self, name, project):
        ...
        self.add_parameter(Parameter_options("file_step", "SIMULATION", ["SIMULATION", "OWN"]))
    ...
    def pre_simulation(self, n_time_steps, delta_t):
        ...
        if self.parameter("file_step").value == "SIMULATION":
            ...
            n = len(self._df_)
            self._initial_date_ = dt.datetime.strptime(self.parameter("initial_time").value, "%d/%m/%Y %H:%M:%S")
